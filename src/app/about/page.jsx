    ...
    <>
      <PageIntro eyebrow="About us" title="Our strength is collaboration">
        ...
        <div className="mt-10 max-w-2xl space-y-6 text-base">
          <p>
          Devplusops was founded with the vision to revolutionize the traditional models of agency services. 
          Our aim was to challenge the norms by providing value-driven solutions that optimize cost 
          without compromising on the quality of our service.
          </p>
          <p>
          Our team at Devplusops is not just a workforce but a family. We believe in nurturing 
          a supportive and inclusive work environment. We value the individuality of our team members 
          and encourage them to bring their unique perspectives and creativity to work every day.
          </p>
          <p>
          Our mission is to provide services that exceed expectations and create lasting relationships with
           our clients, all while cultivating a culture that encourages our team to thrive and achieve 
